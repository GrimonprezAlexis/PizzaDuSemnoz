...
const CustomerSection3 = () => {
  return (
    <section>
        <div className="ad-reservation about-page-shop-details">
            <div className="container ad-reservation-container about-page-shop-details-container">
                ...
                <div className="ad-reservation-line-shape d-none d-md-block">
                    <img src="/img/aida-images/reservation-line-shape.png" alt="" />
                </div>
                <div className="ad-reservation-single-content">
...
export default CustomerSection3