            ...
            <div className='quick-view-container'>
              ...
              <div className='quick-view-text-container'>
                ...
                <div className='quick-view-price-rating'>
                  ...
                  <h4 className='quick-view-price-range'>{product.priceRange}</h4>
                </div>
                <div className="quick-view-product-infos">
                  <p>Indulge in the exquisite flavors of our Grilled Salmon with Lemon Butter Sauce, a culinary masterpiece that's both healthy and mouthwateringly delicious. This dish features a perfectly grilled salmon fillet, renowned for its tender, flaky texture and rich, savory taste.</p>
                </div>
                <div className="quick-view-product-action">
                  <div className="quick-view-product-details-quantity">
                    <button 
                      ...
                      onClick={() => handleQuickViewQuantityChange(quickViewQuantity - 1)}
                    >
                    ...
                    <input
                      ...
                      onChange={(e) => handleQuickViewQuantityChange(Math.max(1, parseInt(e.target.value)))}
                    />
                    <button 
                  ...
                  <a 
                    ...
                    onClick={()=> addToCartWithQuantity(product.id, quickViewQuantity)}
                  >
                    Add to Cart
                  </a>
                  <a 
